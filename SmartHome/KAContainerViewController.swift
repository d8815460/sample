...
class KAContainerViewController: UIViewController {
    ...
    override func viewDidAppear(animated: Bool) {
        ...
        let menu = UIBarButtonItem(title: "", style: .Plain, target: self, action: #selector(KAContainerViewController.touchMenu(_:)))
        menu.image = UIImage(named: "btn_sidemenu_n")
        mainNavigation.viewControllers.first?.navigationItem.setLeftBarButtonItem(menu, animated: true)
